...
#ifndef MasterDeviceController_H
#define MasterDeviceController_H

// define amount of data to send to master
// (+1 for devices' protocol address; see method:  bool getData(uint8_t *buf, uint8_t &len) )
#define DATA_COUNT 2

#include "AbstractDeviceController.h"

class MasterDeviceController : public AbstractDeviceController {
  public:
    MasterDeviceController() {
    }
